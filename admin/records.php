...
<body>
    <div style="margin-bottom: 20px;">
        <a href="dashboard.php" style="display: inline-block; padding: 10px 20px; background: #2d6cdf; color: white; text-decoration: none; border-radius: 5px; font-weight: 500;">← Back to Admin Dashboard</a>
    </div>
    <h2>RECORDS</h2>
    <p>Logged in as: <strong><?=htmlspecialchars($username)?></strong> — <a href="../shared/logout.php">Logout</a> | <a href="audit_trail.php">View Audit Trail</a></p>
        ...
        <tbody>
            <?php while ($r = $all->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <a href="records.php?edit=<?= $r['id'] ?>">Edit</a> |
                        <a href="records.php?delete=<?= $r['id'] ?>">Delete</a>
                    </td>
                </tr>
            <?php endwhile; ?>
        </tbody>
